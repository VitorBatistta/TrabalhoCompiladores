...
public interface JmmParserVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link JmmParser#memberDecl}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitMemberDecl(JmmParser.MemberDeclContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link JmmParser#assignmentExpression}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitAssignmentExpression(JmmParser.AssignmentExpressionContext ctx);
	/**
